...
public class CheckHotel extends JFrame implements Runnable {
    ...
    JLabel[] labels = new JLabel[]{label1, label2, label3, label4, label5, label6, label7, label8, label9};
    CheckHotel(){
    ...
    @Override
    public void run() {
        String [] text = new String[]{"Ring Boutique Hotel SiemReap", "La Residence WatBo", "Central Suite Residence", "Lub D", "Angkor Land Urban Boutique", "Aroma Angkor Boutique", "The Rabbit Hole Hotel & Spa", "Araya Angkor Residence", "Ladear Privilege Angkor"};
        try{
            for (int i = 0; i<=8; i++){
